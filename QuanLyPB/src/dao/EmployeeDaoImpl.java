...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public void updateEmployee(Employee employee) {
		conn = ConnectDB.getConnection();
		String sql = "update nhanvien set tennv = '" + employee.getName() + "', SDT = '" + employee.getPhone()
				+ "', NgaySinh = '" + employee.getDoB() + "', DiaChi = '" + employee.getAddress() + "', MaPb = "
				+ employee.getDepId() + " where manv = " + employee.getId();
		try {
			pst = conn.prepareStatement(sql);
			pst.executeUpdate();
		} catch (SQLException e) {
...
//}
	...
	public void addEmployee(Employee employee) {
		conn = ConnectDB.getConnection();
		String sql = "insert into nhanvien(manv,tennv,sdt,ngaysinh,diachi,mapb) " + "values(?,?,?,?,?,?)";
		try {
			pst = conn.prepareStatement(sql);
